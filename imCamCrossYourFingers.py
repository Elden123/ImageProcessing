...
def main():
    ...
    print(distanceToObject, " distance to object")

    height, width, channels = img.shape

    print(contour[newHighSpot][0][1], contour[newLowSpot][0][1])
    ...
    for l in range(0, len(contour)):
        ...
        if isLowHeight == True:
            break
    if isLowHeight == True:
        print(contour[newLowSpotHeight][0][1], "newLowHeight")
    ...
    print(yFromCenter, "y from center")
    ...
    print(xFromCenter, "x from center")
    ...
    print(xToCorrectReal) / distanceToObject
    xToCorrectAngle = np.arcsin(xToCorrectReal / distanceToObject)
    print(xToCorrectAngle, " x angle")
